...
import { useCreateDocumentMutation } from "../../../redux/features/document/documentApi";
...
const CreateDocument = () => {
	...
	const onFinishHandler = async (e) => {
		...
		try {
			const response = await createDocument(formDataToSend);

			if (response.error) {
				toast.error(response.error.data.errorMessages[0].message);
			} else {
				toast.success(response.data.message);
				navigate("/dashboard/faculty/documents/unapproved-documents");
