...
import DeleteAcademicFaculty from "../../../../components/admin/DeleteAcademicFaculty";
			...
			{isLoading ? (
				...
				<>
					<div className="flex items-center justify-end pb-8">
						<Link
							to="/dashboard/admin/academic-faculty/create"
							...
							<div className="table-content">
								...
								{Data.map((academicFaculty) => (
									...
									>
										<div className="cell">
											<Link
												to={`/dashboard/admin/academic-faculty/${academicFaculty._id}`}
