...
} from "../../../../redux/features/admin/academicSemester/academicSemesterApi";

const AcademicSemesterSingle = () => {
	const { id } = useParams();
	...
	const { data } = useGetAcademicSemesterQuery(id);
	...
	const [academicSemesterSingle, { isLoading }] =
		useUpdateAcademicSemesterMutation();
	...
	const onFinishHandler = async (e) => {
		e.preventDefault();
		try {
			const response = await academicSemesterSingle({ id, formData });
			if (response.error) {
...
export default AcademicSemesterSingle;
