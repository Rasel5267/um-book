...
router.patch('/:id', (0, validateRequest_1.validateRequest)(faculty_validation_1.FacultyValidation.updateFacultyZodSchema), (0, auth_1.default)(user_1.ENUM_USER_ROLE.SUPER_ADMIN, user_1.ENUM_USER_ROLE.ADMIN), faculty_controller_1.FacultyController.updateFaculty);
